...
/**
 * Clase de enrutamiento que define todos los {@code endpoints} relacionados con la gestión de {@link org.vaquitas.model.Animal} (Ganado).
 * <p>
...
public class AnimalRoute {
     ...
     * <tr><td>PATCH</td><td>/ganado/{id}</td><td>Da de baja (Muerto) un animal específico.</td></tr>
     * </table>
     *
