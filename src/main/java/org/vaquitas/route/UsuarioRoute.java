...
/**
 * Clase de enrutamiento que define todos los {@code endpoints} relacionados con la gestión de {@link org.vaquitas.model.Usuario}.
 *
 * @author VaquitaSoft
 * @version 1.0
 * @since 2025-10-19
...
public class UsuarioRoute {
     ...
     * <tr><td>POST</td><td>/usuarios/login</td><td>Autentica un usuario (Login) y retorna un token.</td></tr>
